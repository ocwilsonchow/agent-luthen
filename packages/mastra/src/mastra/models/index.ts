...
type ModelType = "base" | "observation" | "tool" | "fast" | "drugProfile"
...
export const vercelModels = {
  ...
  /** Dedicated generate model for getDrugProfile. Swap this id later. */
  drugProfile: createVercelModelConfig(
    gateway("google/gemini-3.5-flash-lite").modelId
  ),
